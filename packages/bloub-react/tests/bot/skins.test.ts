...
import { decalageDesYeux, POUR_TESTS } from '../../src/bot/eyefit';
import { DEFAULT_SHAPE, SHAPE_BY_ID, SHAPES } from '../../src/bot/skins';
import { type StateId, STATES } from '../../src/bot/states';
