import { type Block, clampDuration, makeBlock } from 'bloub-react';
import { TOUR_TIME, tourLook } from './gaze-studio';
...
/** Ce que font les yeux pendant l'arrivee. Voir `tourLook` dans `./gaze-studio`. */
